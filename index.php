...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html"><img src="assets/img/nombre.png" alt="" width="150px"></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="services.html">Más planes</a></li>
          ...
          <li><a href="index.html" class="getstarted"><b>Contratar ahora!</b></a></li>
        </ul>
