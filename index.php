...
<body>
  ...
  <section id="planes" class="services">
    <div class="col-lg-1">&nbsp;</div>
    <div class="col-lg-10">

      <div class="container about content">
        <h2 align="center"><b>Planes de internet Emenet Comunicaciones.</b></h2>
        <h3 align="center">Elige el plan ideal para ti y tu familia.</h3>
        <br><br>
      </div>

      <div class="tarjeta col-md-6 col-lg-3 pb-3">
        ...
        <div class="card card-custom bg-white border-white border-0">
          ...
          <div class="card-body" style="overflow-y: auto">
            ...
            <p>
              <hr>
                <center>
                  <label for=""><img src="assets/img/palomita.png" alt="" width="20px"> INTERNET ILIMITADO</label><br>
                  <label for=""><img src="assets/img/palomita.png" alt="" width="20px"> TV</label><br>
                  <label for=""><img src="assets/img/palomita.png" alt="" width="20px"> PELICULAS</label><br><br>
